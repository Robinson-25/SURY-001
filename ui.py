"""ui.py — 100% Custom Gold-Themed Dynamic Bento PyQt6 User Interface for SURY.
...
class DeviceSettingsDialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("SURY Settings Configuration Control")
        self.resize(550, 740)
        self.update_style()
...
class MainWindow(QMainWindow):
    ...
    def _setup_tray_icon(self):
        ...
        show_action = tray_menu.addAction("Mostrar SURY")
...
class JarvisUI:
    ...
    def ensure_startup_shortcut(self):
        try:
            ...
            shortcut_path = os.path.join(startup_dir, 'SURY AI.lnk')
